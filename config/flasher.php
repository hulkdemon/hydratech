...
return [
    'presets' => [
        ...
        'registro_validado' => [
            'type' => 'error',
            'message' => 'No se puede eliminar un registro relacionado',
            'title' => 'Error',
        ],
        'guardar_uma' => [
            'type' => 'success',
            'message' => 'El UMA para este año ha sido registrado.',
            'title' => 'Éxito',
        ],
        'error_uma' => [
            'type' => 'warning',
            'message' => 'Ya se ha registrado un UMA para el año actual.',
            'title' => 'Error',
        ],
        'fecha_uma' => [
            'type' => 'error',
            'message' => 'La fecha de aplicación debe ser del año actual, no anterior o superior.',
            'title' => 'Error',
        ],
        'concepto' => [
            'type' => 'success',
