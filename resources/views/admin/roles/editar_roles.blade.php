        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edición de roles</li>
                </ol>
                </div>
            </div>
            </div><!-- /.container-fluid -->
        </section>
                <form action="{{url('admin/roles/' .$rol->id_rol )}}" method="post">
                    @csrf
                    @method("PUT")
                    <!-- Input addon -->
                    <div class="card card-info">
                        <div class="card-header">
                          <h3 class="card-title">Datos del rol a editar</h3>
                        </div>
            <div class="card-body">
<label>Nombre del rol a editar:</label>
                        <!-- Date mm/dd/yyyy -->
                        <div class="form-group">
                            ...
                            <input type="text" name="tipo" class="form-control" id="tipo" value="{{$rol->tipo}}" >
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
