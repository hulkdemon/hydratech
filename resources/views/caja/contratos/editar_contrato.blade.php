        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edición de contratos</li>
                </ol>
                </div>
            </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Datos del contrato a editar</h3>
                </div>
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="correo_electronico" class="form-control" id="correo_electronico" value="{{$contrato->correo_electronico}}" placeholder="Ingrese el correo opcional para poder obtener el recibo de manera electrónica automáticamente">
                    </div>
                    <!-- /.input group -->
                </div>
                <label>Tipo de contrato a editar:</label>
                <!-- Date mm/dd/yyyy -->
                <div class="form-group">
                    <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <select name="tipo_contrato" id="tipo_contrato" class="form-control">
                        <option value="">Seleccione el tipo de contrato que se editará del contrato</option>
