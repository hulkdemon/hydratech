    ...
    @endif
        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <form action="{{url('caja/contratos')}}" method="post">
                    @csrf
                    <!-- Input addon -->
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="correo_electronico" class="form-control" id="coreo_electronico" value="{{old('correo_electronico')}}" placeholder="Ingrese el correo opcional para poder obtener el recibo de manera electrónica automáticamente">
                            </div>
                            <!-- /.input group -->
                        </div>
